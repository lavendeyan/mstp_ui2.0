            ...
            <Modal
                ...
                <Form.Item label="物品名称">
                        {getFieldDecorator('goods_id', {
                            rules: [{ required: true, message: '请选择打包的物品名称!' }],
                        })(
                    ...
                    <Form.Item label="打包详情">
                        {getFieldDecorator('detail', {
                            rules: [{ required: true, message: '请输入打包描述!' }],
                        })(<Input placeholder="打包详情"/>)}
                    </Form.Item>
                    <Form.Item label="打包时间">
                        {getFieldDecorator('cleantime', {
                            rules: [{ required: true, message: '请输入打包时间!' }],
